...
public class MainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // code to display Bascom Hall destination marker
        ...
        else
        {
            mFusedLocationProviderClient.getLastLocation().addOnCompleteListener(this,task ->
            {
                ...
                if(task.isSuccessful() && mLastKnownLocation != null)
                {
                    ...
                    // move camera
                    mMap.moveCamera(CameraUpdateFactory.newLatLng(new LatLngBounds(mLastKnownLatLng,mDestinationLatLng).getCenter()));
                    mMap.moveCamera(CameraUpdateFactory.zoomTo(3));
                    // add current position marker
                    mMap.addMarker(new MarkerOptions().position(mLastKnownLatLng).title("Current"));
